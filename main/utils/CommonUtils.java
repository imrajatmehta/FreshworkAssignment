...
/**
 * @author Rajat Mehta This class Handles general util methods like validation,
	...
	public static boolean isKeyExists(String key, String filePath) {
		...
		try {
			...
			if (isKeyExists) {
				...
				if (data.getTimeToLive() > 0 && (currentDateTimeMillis
						- data.getCreationDateTimeMillis()) >= (data.getTimeToLive() * Constants.MILLISECONDS)) {
